 ...
 */
 ...
 import io.cdap.directives.column.AggregateStatsDirective;
   ...
   public SystemDirectiveRegistry(List<String> namespaces) throws DirectiveLoadException {
     ...
     for (String namespace : namespaces) {
       try {
         ...
         // ✅ Manually register your custom directive
         registry.put("aggregate-stats", DirectiveInfo.fromSystem(AggregateStatsDirective.class));
